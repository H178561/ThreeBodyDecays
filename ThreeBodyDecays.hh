...
class WignerRotation : public AbstractWignerRotation {
  ...
  public:
    WignerRotation( int k_, bool is_positive_, bool is_even_ ) :
        k( k_ ), is_positive_( is_positive_ ), is_even_( is_even_ )
    {
    }
    virtual double operator()( double w, const std::array<double, 3>& sigma,
                               const std::array<double, 4>& ms2 ) const = 0;
...
class Arg0WignerRotation : public WignerRotation {
  public:
    Arg0WignerRotation( int k_, bool is_positive_ ) :
        WignerRotation( k_, is_positive_, true )
    {
    }
    double operator()( double w, const std::array<double, 3>& sigma,
                       const std::array<double, 4>& ms2 ) const override
...
class Arg2WignerRotation : public WignerRotation {
  public:
    Arg2WignerRotation( int k_, bool is_positive_, bool is_even_ ) :
        WignerRotation( k_, is_positive_, is_even_ )
    {
    }
    double operator()( double w, const std::array<double, 3>& sigma,
                       const std::array<double, 4>& ms2 ) const override
...
class Arg3WignerRotation : public WignerRotation {
  public:
    Arg3WignerRotation( int k_, bool is_positive_ ) :
        WignerRotation( k_, is_positive_, true )
    {
    }
    double operator()( double w, const std::array<double, 3>& sigma,
...
class Flatte : public Lineshape {
  public:
    Flatte( double mass, double g1, double g2, double m1, double m2 ) :
        m_( mass ), g1_( g1 ), g2_( g2 ), m1_( m1 ), m2_( m2 )
    {
    }
...
class BuggBW : public Lineshape {
  public:
    BuggBW( double mass, double width, double s0, double s1, double s2 ) :
        mass_( mass ), width_( width ), s0_( s0 ), s1_( s1 ), s2_( s2 )
    {
    }
...
class ThreeBodyDecays {
  public:
    ...
    complex amplitude(const DecayChain& dc,  const MandelstamTuple& σs, const std::vector<int>& two_λs, const std::vector<int>& refζs);
    complex amplitude0(const DecayChain& dc, const MandelstamTuple& σs, const std::vector<int>& two_λs);
    std::vector<std::vector<std::vector<std::vector<complex>>>> amplitude4dold(const DecayChain& dc, const MandelstamTuple& σs, const std::vector<int>& refζs);
