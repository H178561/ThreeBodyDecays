...
std::cout
      ...
      << approx_equal( cosζ333, 1.0 ) << std::endl;
        ...
        auto dc = createDecayChainLS(
            ...
            std::make_shared<ThreeBodySystem>(ms, spins),  // ThreeBodySystem als shared_ptr
        ...
        for (int _1 = 0; _1 < dims[1]; _1++) {
            for (int _2 = 0; _2 < dims[2]; _2++) {
                for (int _3 = 0; _3 < dims[3]; _3++) {
                    ...
                    int perm_i = (i_idx == 0) ? _0 : (i_idx == 1) ? _1 : (i_idx == 2) ? _2 : _3;
...
ThreeBodyParities::ThreeBodyParities(char P1, char P2, char P3, char P0) :
    P1_(P1), P2_(P2), P3_(P3), P0_(P0)
{
}
